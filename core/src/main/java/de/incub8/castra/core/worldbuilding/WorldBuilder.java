...
public class WorldBuilder
{
    ...
    private static final Settlement SETTLEMENT_1 = new Settlement(
        ...
        100,
        HUMAN,
        new TextureDefinition(new Texture(Gdx.files.internal("castleHuman.png")), new GridPoint2(45, 28)));
    private static final Settlement SETTLEMENT_2 = new Settlement(
        SettlementSize.LARGE,
        new GridPoint2(1300, 700),
        100,
        AI,
        new TextureDefinition(new Texture(Gdx.files.internal("castleAI.png")), new GridPoint2(45, 28)));
    private static final Settlement SETTLEMENT_3 = new Settlement(
        SettlementSize.MEDIUM,
        new GridPoint2(130, 500),
        20,
        NEUTRAL,
        new TextureDefinition(new Texture(Gdx.files.internal("castleNeutralMedium.png")), new GridPoint2(35, 21)));
    ...
    private static final Settlement SETTLEMENT_5 = new Settlement(
        ...
        30,
        NEUTRAL,
        new TextureDefinition(new Texture(Gdx.files.internal("castleNeutralSmall.png")), new GridPoint2(25, 20)));
